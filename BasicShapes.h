...
class circle :public shape
{
	...
	int rad;
public:
	circle(game* r_pGame, point ref, int r, int r_rad);	//add more parameters for the constructor if needed
	virtual void draw() const;
};
...
class triangle :public shape
{
	...
	int length;
public:
	triangle(game* r_pGame, point ref, int length1, int length2,int length3);	//add more parameters for the constructor if needed
	virtual void draw() const;
};